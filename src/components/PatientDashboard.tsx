...
export const PatientDashboard = () => {
 ...
 const handleSearch = async () => {
  ...
  if (!selectedDepartment.trim()) {
    ...
    setSearchError("Please select your department");
  ...
  try {
    ...
    const res = await fetch(
      ...
      `http://localhost:4000/api/patients/${encodeURIComponent(tokenSearch)}/${encodeURIComponent(selectedDepartment)}`
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setTokenSearch(e.target.value.trim())}
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${foundPatient.status === 'Completed' ? 'bg-secondary text-secondary-foreground' :
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className={`font-semibold ${foundPatient.isEmergency ? 'text-destructive' :
                      ...
                      {getWaitingPatients(foundPatient.department).slice(0, 5).map((patient, index) => {
                        ...
                        return (
                          ...
                          <div
                            ...
                            className={`flex items-center justify-between p-3 rounded-lg transition-all duration-300 ${isCurrentPatient ? 'bg-primary/10 border-2 border-primary ring-2 ring-primary/20' :
                          ...
                          >
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${isCurrentPatient ? 'bg-primary text-primary-foreground' :
